...
import torch
import collections
from inceptionv3_bth_train import Inception3
...
def get_all_systems_table(df, device):
    ...
    # normalize Bg and Bth true values
    #bg_true_norm = mike.norm_bg(bg_true)
    #bth_true_norm = mike.norm_bth(bth_true)
...
def main():
    ...
    checkpoint = torch.load("/media/sayko/storage1/BgBth-models/Bg-train-optuna/model_end.pt")
