...
def plot_data(eval_y, eval_pred):
    ...
    bg_true, bth_true, pe_true = mike.unnormalize_params(eval_y)
    bg_pred, bth_pred, pe_pred = mike.unnormalize_params(eval_pred)
    ...
    ax_bg.scatter(bg_true, bg_pred, c='b', s=18)
    #ax_bth.scatter(bth_true_ath, bth_pred_ath,c='r', s=18)
    #ax_bth.scatter(bth_true_g, bth_pred_g,c='b', s=18)
    ax_bth.scatter(bth_true, bth_pred,c='b', s=18)
    ax_pe.scatter(pe_true, pe_pred,c='b', s=18)
