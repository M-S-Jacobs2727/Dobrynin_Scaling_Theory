...
def main():
    ...
    print(f'Epoch\ttrain_loss\tBth Train Error\ttest_loss\tBth Test Error\ttime', flush=True)
    ...
    for m in range(epochs):
        ...
        print(f'{m}\t{train_loss:>8f}\t{bth_train_error:.4f}\t{test_loss:>8f}\t{bth_valid_error:.4f}\t{elapsed:.2f}', flush=True)
